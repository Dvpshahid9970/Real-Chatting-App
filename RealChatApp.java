...
public class RealChatApp extends javax.swing.JFrame 
{
    ...
    private void initComponents() {
        ...
        setTitle("RealChat V2.131 by Mohammad Shahid");
        ...
        jPanel2.setBackground(new java.awt.Color(52, 235, 186));
        ...
        jButton2.setBackground(new java.awt.Color(52, 235, 186));
        ...
        jLabel8.setForeground(new java.awt.Color(0, 204, 24));
        jLabel8.setText("        Real Chat - Lets Chat");
...
void seticon()
{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RealChatApp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
              RealChatApp root = new RealChatApp();  //initializing the main gui
...
/*
Created and Managed by Mohammad Shahid
*/
